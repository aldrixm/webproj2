...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .nav-links a.active { background:rgba(0,0,0,0.06); font-weight:700; }
    .nav-links a.cta { background:#2b6bf7; color:#fff; }
    ...
    .register a:hover { background: #00796b; }
  </style>
</head>
<body>
    ...
    <form action="register.php" method="post" autocomplete="off">
      ...
      <div class="input-group">
        ...
        <input type="password" id="password" name="password" placeholder="Enter your password" 
               ...
               pattern="(?=.*\d)(?=.*[A-Za-z]).{8,}"
               title="Password must be at least 8 characters, contain letters and numbers" required />
      </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO user (name, email, password, birthday) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $name, $email, $hashed_password, $birthday);
